...
namespace Example30May
{
    internal class Task1
    {
		...
		/// </summary>
		public static void ExampleWhileCount() 
        {
			...
			while (count > 0)
			{
				Task1.ExampleWhile(countLength);
				count--;
			}
		}
		#endregion
		...
		public static void ExampleWhile(int count)
        {
		...
		#region ExampleDoWhile

		/// <summary>
		/// User'dan UserName ve Password isteyir ve hemin UserName ve Passwordu dogru olub olmadigini yoxlayir
		/// </summary>
		/// <param name="UserName">Userin daxil etdiyi Adi</param>
		/// <param name="Password">Userin daxil etdiyi Parolu </param>
		/// 
		...
		#region ExampleEmptySquare


		public static void ExampleEmptySquare(int count) 
        {
